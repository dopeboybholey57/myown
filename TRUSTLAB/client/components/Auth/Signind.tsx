...
const Signind = () => {
  ...
  const loginwithgoogled = ()=>{
    window.open("http://localhost:6005/auth/google/callbackdoctor", "_self")
  }

  return (
    <>
      {/* <!-- ===== SignIn Form Start ===== --> */}
      <section className="pb-12.5 pt-32.5 lg:pb-25 lg:pt-45 xl:pb-30 xl:pt-30">
