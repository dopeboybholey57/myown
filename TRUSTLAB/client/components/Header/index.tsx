...
const Header = () => {
  ...
  return (
    <header
      className={`fixed left-0 top-0 z-99999 w-full py-5 ${stickyMenu
          ? "bg-white !py-4 shadow dark:bg-black"
          : ""
        }`}
    >
      <div className="relative mx-auto max-w-c-1390  px-4 md:px-8 xl:flex 2xl:px-0">
        ...
        >
          <nav>
            <ul className="flex flex-col gap-5 xl:flex-row xl:items-center xl:gap-10 xl:ml-25">
