  ...
  return (
    <footer>
        ...
        <div className='w-full flex flex-col md:flex-row py-20 px-8 md:px-10 gap-10 lg:gap-20 justify-between'>
            <p className='text-lg text-white font-semibold '>Hyderabad, Telangana, India - 500017</p>
            ...
            <div className='flex flex-col gap-5 text-md text-white'>
                <p>sadanandbholenath57@gmail.com</p>
                <p>+91 955030 5134</p>
            </div>
        </div>
        ...
        <div className='flex flex-col gap-10 items-center justify-center pb-20 '>
            ...
            <div className='flex gap-10 text-white text-2xl mb-10 mt-2'>
            ...
            <p className='text-gray-400 text-md tracking-wider'>@2023 Bholenath S</p>
        </div>
    </footer>
  )
}
