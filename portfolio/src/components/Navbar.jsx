        ...
        <div className="px-0 2x1:px-40">
            <div className='w-full items-center justify-between py-4 px-10'>
                <div className='flex items-center justify-between w-full'>
                    <a href='/'
                        className='text-2xl font-bold text-blue-500 cursor-pointer'>Bholenath
                    </a>
                    ...
                    <div className='md:hidden'>
                        ...
                        onClick={toggleMenu}
                        >
                            <BiMenu size={26} className={`${isOpen ? "hidden" : "block"} text-gray-700 dark:text-gray-300`} />
                            <AiOutlineClose
                            size={26}
                    ...
                    {/* Mobile Menu */}
                <div className={`${isOpen ? "block pt-4" : "hidden"} md:hidden`}
                id='mobile-menu'
                >
                    <div className='flex flex-col gap-4 text-md text-gray-700 dark:text-neutral-200'>
                        ...
                        className='cursor-pointer'>About
                        </a>
                        <a href='#projects' onClick={toggleMenu}
                        className='cursor-pointer'>Projects
                        </a>
                    </div>
                </div>
            </div>
